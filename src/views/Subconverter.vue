        ...
        remoteConfig: [
          {
            ...
            options: [
              {
                label: "小雷专属",
                value: "https://raw.githubusercontent.com/Xiaoleimt/1/main/clash.ini"
              },
              {
                label: "默认",
...
function closeTanchuang() {
  let msgbox = document.querySelector('.msgbox'); // 弹窗容器元素
  if (msgbox) {
    msgbox.parentNode.removeChild(msgbox); // 从DOM中移除弹窗容器元素
  }
}
